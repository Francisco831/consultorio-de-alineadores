...
const REGLAS: Regla[] = [
  ...
  // Beneficiarios identificados con los comprobantes de Pagos/ (20/8/26) —
  // ver scripts/reclasificar-bnet-mx.ts para el mapeo completo:
  { patron: /BNET 1536586592/, categoria: "Sueldos administración",
    contraparte: "Juan Andrés Banffi", kindContraparte: "employee",
    nota: "gerente MX; comprobantes 'Sueldo Juan'" },
  { patron: /BNET 0194724011/, categoria: "Depto Juan (vivienda)",
    contraparte: "Weston Bienes Raíces SAPI (depto Juan)", kindContraparte: "supplier",
    nota: "alquiler de la vivienda de Juan" },
  { patron: /00072580013228165398|0\d{5}26JESUS|SUELDO ENERO 26/, categoria: "Sueldos producción",
    contraparte: "Jesús (laboratorio)", kindContraparte: "employee",
    nota: "'JESUS LAB' en el comprobante: laboratorio" },
  { patron: /BNET 1580002821/, categoria: "Sueldos producción",
    contraparte: "Isabel Guadalupe Hernández Díaz", kindContraparte: "employee",
    nota: "'ISABEL LAB' en el comprobante: laboratorio" },
  { patron: /BNET 1590619097/, categoria: "Sueldos administración",
    contraparte: "Angélica Beatriz Portugal Bouza", kindContraparte: "employee",
    nota: "finiquito agosto 2026" },
  { patron: /BNET 1512798293/, categoria: "Sueldos administración",
    contraparte: "Úrsula Andrea Pluma Cano", kindContraparte: "employee",
    nota: "finiquito abril 2026" },
  { patron: /BNET 2915209536/, categoria: "Honorarios contables",
    contraparte: "Gerardo Estrada Tochimani (contador)", kindContraparte: "supplier" },
