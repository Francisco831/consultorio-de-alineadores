...
const REGLAS: Regla[] = [
  ...
  { patron: /Cornejo Leyva/i,
    categoria: "Consumibles de producción", contraparte: null,
    nota: "escaneos de pacientes (confirmado Pancho 20/8/26)" },
  { patron: /Juarez Bautista/i,
    categoria: "Packaging", contraparte: null,
    nota: "cajas donde van los alineadores (confirmado Pancho 20/8/26)" },
